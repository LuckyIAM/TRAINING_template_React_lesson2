        ...
        <Container>
            <Row>
                ...
                <Col xs={12} md={4}>
                    ...
                    <div><strong className={p.discount ? "text-danger" : "text-darck"}>
                        {Math.ceil(p.price - (p.discount * p.price / 100))}₽</strong>
                    </div>
                    <Row>
                        <Col md={6}>
                            <ButtonGroup >
                    ...
                    <Alert variant="secondary" className="mt-3">
                        <Row>
                            <Col md={2}><Truck/></Col>
                            <Col md={10}><small>Доставка по всему миру!</small></Col>
                        </Row>
                     </Alert>
                </Col>
                <Col xs={12}>
